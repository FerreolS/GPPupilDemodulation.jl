...
function buildstates(faintstates::FaintStates{T,A},timestamp::AbstractVector; lag::Integer=0,preswitchdelay =300,postwitchdelay =300) where {T<:AbstractFloat,A<:AbstractVector{T}}
	N = length(timestamp)
