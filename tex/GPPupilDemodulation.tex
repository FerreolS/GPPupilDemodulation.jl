...
% \begin{align}
% x_{mod}(t) &= x_0 + a' \sin\left(b \sin\left(2\,\pi\frac{t}{f} + \phi\right) + \phi_2\right) \label{eq:x0} \\
% y_{mod}(t) &= y_0 + a' \cos\left(b \sin\left(2\,\pi\frac{t}{f}\,t + \phi\right) + \phi_2\right)\,,\label{eq:y0}
% \end{align}
% where $\omega = 2\,\pi$ is the known modulation pulsation. $(x_0,y_0)$ is the position of center of the pupil, $a'$ and $b$ are amplitude terms, $\phi$   and $\phi_2$ are phase terms. All these 6 terms as to be estimated in order to demodulate the metrology signal. 
...
% \begin{equation}
%     \V{v} = c + a \exp\left( \jmath \, b \sin\left( \V{\omega} + \phi\right)\right)\,.\label{eq:v}
% \end{equation}
